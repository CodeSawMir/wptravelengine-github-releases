...
define( 'WPTE_DZ_GITHUB_VERSION',              '1.1.0' );
...
define( 'WPTE_DZ_GITHUB_OPTION_FAVORITES',    'wpte_dz_github_favorites' );
define( 'WPTE_DZ_GITHUB_OPTION_LAST_INSTALLED', 'wpte_dz_github_last_installed' );
